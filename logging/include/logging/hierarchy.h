#ifndef LOGGING_HIERARCHY_HEADER_
#define LOGGING_HIERARCHY_HEADER_
...
namespace logging {
	 ...
	 */
	class LOGGING_EXPORT Hierarchy
	{
	public:
		 ...
		 */
		virtual bool exists(const logging::tstring& name);

		/**
		 * Similar to {@link #disable(LogLevel)} except that the LogLevel
		 * argument is given as a logging::tstring.
		 */
		virtual void disable(const logging::tstring& loglevelStr);
		 ...
		 */
		virtual Logger getInstance(const logging::tstring& name);
		 ...
		 */
		virtual Logger getInstance(const logging::tstring& name, spi::LoggerFactory& factory);
	...
	private:
		...
		typedef std::map<logging::tstring, ProvisionNode> ProvisionNodeMap;
		typedef std::map<logging::tstring, Logger> LoggerMap;
		...
		// Methods
		   ...
		   */
		LOGGING_PRIVATE
			Logger getInstanceImpl(const logging::tstring& name,
		 ...
		 */
		LOGGING_PRIVATE void updateParents(Logger const & logger);
		 ...
		 */
		LOGGING_PRIVATE void updateChildren(ProvisionNode& pn,
			Logger const & logger);
	...
	LOGGING_EXPORT Hierarchy & getDefaultHierarchy();


} // end namespace logging

#endif // LOGGING_HIERARCHY_HEADER_
