#ifndef LOGGING_LAYOUT_HEADER_
#define LOGGING_LAYOUT_HEADER_
...
namespace logging {
	...
	public:
		...
		virtual void formatAndAppend(logging::tostream& output,
			const logging::spi::InternalLoggingEvent& event) = 0;
	 ...
	 */
	class LOGGING_EXPORT SimpleLayout
		: public Layout
	{
	public:
		SimpleLayout();
		SimpleLayout(const logging::helpers::Properties& properties);
	...
	LOGGING_EXPORT helpers::Time const & getTTCCLayoutTimeBase();
	 ...
	 * LOGGING_DEBUG(root, "Message 1");
	 * LOGGING_WARN(root, "Message 2");
	 * ~~~~
	 *
	 ...
	 *   <li>%%q -- milliseconds as decimal(0-999) -- <b>logging specific</b>
	 *   <li>%%Q -- fractional milliseconds as decimal(0-999.999) -- <b>logging specific</b>
	 ...
	 *   <code>LOGGING_DISABLE_FUNCTION_MACRO</code> macro, %M
	 ...
	 *
	 */
	class LOGGING_EXPORT PatternLayout
		: public Layout
	{
	public:
		// Ctors and dtor
		PatternLayout(const logging::tstring& pattern);
		PatternLayout(const logging::helpers::Properties& properties);
	...
	protected:
		void init(const logging::tstring& pattern, unsigned ndcMaxDepth = 0);

		// Data
		logging::tstring pattern;
