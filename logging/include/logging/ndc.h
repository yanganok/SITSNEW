...
namespace logging {
	 ...
	 *
	 * If configured to do so, {@link logging::PatternLayout} and
	 * {@link logging::TTCCLayout} instances automatically retrieve
	...
	public:
		 ...
		 */
		logging::tstring const & get() const;
		 ...
		 * @return String The innermost diagnostic context.
		 */
		logging::tstring const & peek() const;
		 ...
		 */
		void push(const logging::tstring& message);
	...
	private:
		// Methods
		LOGGING_PRIVATE static DiagnosticContextStack* getPtr();
	 ...
	 */
	LOGGING_EXPORT NDC& getNDC();


	/**
	 * This is the internal object that is stored on the NDC stack.
	 */
	struct LOGGING_EXPORT DiagnosticContext
	{
		// Ctors
		DiagnosticContext(const logging::tstring& message,
		...
		// Data
		logging::tstring message; /*!< The message at this context level. */
		logging::tstring fullMessage; /*!< The entire message stack. */
	};
	 ...
	 */
	class LOGGING_EXPORT NDCContextCreator {
	public:
		/** Pushes <code>msg</code> onto the NDC stack. */
		explicit NDCContextCreator(const logging::tstring& msg);
